-- who is the senior based on job title
...
-- that has the highest sum of invoice totals. Return both city name and sum of all invoice
-- totals
...
-- and the total track count of the top 10 rock bands
...
-- We determined the most popular genre as the genre with the 
-- highest amount of purchases. Write a query that returns each country along with the top Genre. For countries where the 
...
-- Write a query that returns the country  along with the top customer and how mush they spent. For countries where the top
